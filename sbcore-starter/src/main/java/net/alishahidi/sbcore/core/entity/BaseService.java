package net.alishahidi.sbcore.core.entity;

import net.alishahidi.sbcore.core.search.SearchParamsWrapper;
import net.alishahidi.sbcore.core.util.SpecificationBuilder;
